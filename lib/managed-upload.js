const fs = require('fs');
const { stat: statFile } = require('fs/promises');
const util = require('util');
const path = require('path');
const mime = require('mime');
const { isReadable } = require('is-type-of');
 ...
 * @param {String|File|Buffer} file file
      ...
      return new Promise(async (resolve, reject) => {
        try {
          if (!self.isCancel()) {
            ...
            if (Array.isArray(self.multipartUploadStreams)) {
