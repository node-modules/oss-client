...
function formatFn(_) {
  dataFix_1.dataFix(_, { bool: [ 'IsEnabled' ] }, conf => {
    ...
    // optionalFields
    if (((_a = conf === null || conf === void 0 ? void 0 : conf.OptionalFields) === null || _a === void 0 ? void 0 : _a.Field) && !Array.isArray((_b = conf.OptionalFields) === null || _b === void 0 ? void 0 : _b.Field)) { conf.OptionalFields.Field = [ conf.OptionalFields.Field ]; }
  });
  // firstLowerCase
